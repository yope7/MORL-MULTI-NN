...
from myagent import DQNAgent_without_action_filter, WTPAgent, CostPAgent, RandomAgent
from mypolicy import EpsGreedyQPolicy_decay
...
EGQpolicy_d = EpsGreedyQPolicy_decay(eps=1, min_eps=.01, eps_decay=.99999)
...
dqn = DQNAgent_without_action_filter(
...
episode_logger_dqn.loss[0] = episode_logger_dqn.loss[1]
