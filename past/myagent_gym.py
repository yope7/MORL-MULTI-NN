    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
        ...
        try:
            while self.step < nb_steps:
                ...
                callbacks.on_step_end(episode_step_without_invalid, step_logs)
                ...
                if done: # episode終了時
                    ...
                    if hv_diff > 0:
                        reward_final += (5000)
                        self.backward(5000, terminal=False)
                ...
                # ウィンドウの履歴をCSVファイルに出力
                    ...
                    wandb.log({"my_step":episode_step, "my_step_without_invalid,":episode_step_without_invalid,
                               "episode_loss":episode_loss/episode_step,'episode_reward_cost': episode_reward[0],'epi_co_mean':episode_reward[0]/episode_step,"episode_reward_wt":episode_reward[1]/episode_step_without_invalid,"episode_cost":episode_cost/episode_step_without_invalid, "episode_time":episode_time/episode_step, 'nb_episode_steps': episode_step, 'nb_steps': self.step, 'end_time': time, 'jobs': env.jobs, 'waiting_time': waiting_time_sum/episode_step,"hypervolume":hypervolume,"hv_diff":hv_diff,"episode_cost_without_minus":episode_cost_without_minus,"waiting_time_sum":waiting_time_sum,"reward_final":reward_final,'hint':hint})
