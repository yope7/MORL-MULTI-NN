...
from episode_model_myagent_gym import  WTPAgent, CostPAgent, RandomAgent, MyAgent
...
EGQpolicy_d = EpsGreedyQPolicy_with_action_filter_and_decay(eps=1, min_eps=.01, eps_decay=.99999)
